...
% ── Helpers ──────────────────────────────────────────────────
% Inline university logo (height matches font size)
\newcommand{\unilogo}[1]{%
...
\begin{tabularx}{\linewidth}{@{}X r@{}}
  ...
  &
  \begin{tabular}[b]{@{}r@{}}
    \small\href{mailto:zhuhe@stu.pku.edu.cn}{zhuhe@stu.pku.edu.cn} {\small/} \href{mailto:zhuye140@gmail.com}{zhuye140@gmail.com}\\[2pt]
    \small (+86) 189-0301-0858 \quad \href{https://zhuchichi56.github.io}{https://zhuchichi56.github.io}
  \end{tabular}
\end{tabularx}
...
currently a Research Intern with the \textbf{Meituan LongCat Team}
(Top Talent),
after an internship with the \textbf{Microsoft Research Asia GenAI Group}.
...
\entry{\unilogo{pku.png}\enskip Peking University}{Beijing, China}
...
\begin{itemize}
  ...
  \item \textbf{Visiting}: \unilogo{utokyo.png}\,\href{https://www.csis.u-tokyo.ac.jp/}{UTokyo CSIS} (2022, 2023); \unilogo{nus.png}\,\href{https://www.comp.nus.edu.sg/}{NUS CS} (2022).
\end{itemize}

% ── EXPERIENCE ───────────────────────────────────────────────
\section{Experience}

\entry{Meituan $\cdot$ LongCat Team}{Beijing, China}
\textit{Research Intern (Top Talent)}. \hfill \textit{Jul 2026 -- Present}\\[1pt]
Built the LongCat DeepResearch harness (top-1/top-2 on DRB I/II and ResearchRubrics);
synthesizing long-horizon data to strengthen its research capabilities.

\vspace{4pt}
\entry{Microsoft Research Asia $\cdot$ GenAI Group}{Beijing, China}
\textit{Research Intern}. \hfill \textit{Nov 2025 -- Jun 2026}\\[1pt]
...
\noindent\textbf{LongCat DeepResearch}: built the
DeepResearch harness (top-1/top-2 on DRB I/II and ResearchRubrics) and synthesized
long-horizon data to strengthen LongCat.

\vspace{4pt}
\noindent\textbf{PlanGPT Series}: urban-planning LLMs and benchmarks.
\hfill {\small\href{https://plangpt.github.io}{plangpt.github.io}}

\vspace{1pt}
\noindent\textbf{UrbanClaw} \hfill
{\small\href{https://app.urbanclaw.net}{app.urbanclaw.net}}\\[1pt]
Urban-planning agent with multi-agent collaboration, sandboxing, MCP, and self-evolving skills.

\newpage
% ── PUBLICATIONS ─────────────────────────────────────────────
\section{Publications}

\noindent\textit{First-/Co-first Author / Corresponding Author \quad ($^{*}$ equal contribution; $^{\dagger}$ corresponding author)}
...
\pub{AlignDiff: Exploiting Model-Intrinsic Information for Better Data Selection}{\tdata}
    ...
    {EMNLP 2026 (Findings) \quad[\href{https://openreview.net/forum?id=4fclVIrUg2}{paper}]}
...
\begin{itemize}
  \item \textbf{Area Chair}: EMNLP 2026; \textbf{Reviewer}: ACL Rolling Review (ARR).
